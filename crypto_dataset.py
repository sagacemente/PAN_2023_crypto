...
class Dataset:
    ...
    def fetch_ds_files(self):
        if 'augmented' in self.url:
            ...
            train_set_archive = tf.keras.utils.get_file('pan23-profiling-cryptocurrency-influencers-augmented-it.zip',self.url,
    ...
    def organize_ds_folders(self):
        #############   LABELS TRUTH  
        train_truth_file_path = os.getcwd() + '/pan23-profiling-cryptocurrency-influencers-augmented-it/' + self.subtask + '/train_truth.json'
        ...
        #############  TEXTS 
        train_texts_path = os.getcwd() + '/pan23-profiling-cryptocurrency-influencers-augmented-it/'  + self.subtask  + '/train_text.json'
